...
class Customization(enum.Enum):
    ...
    SKIN_COLOR = enum.auto()
    HAIR_HEADGEAR = enum.auto()
    FACIAL_HAIR_MASKS = enum.auto()
    HAIR_COLOR = enum.auto()
    EAR_SHAPE = enum.auto()
    NOSE_SHAPE = enum.auto()
    MOUTH_SHAPE = enum.auto()
    EYEBROW = enum.auto()
    EYELASH = enum.auto()
    EYE_SHAPE = enum.auto()
    PUPIL = enum.auto()
    ...
    SCAR_FLIP = enum.auto()
    TATTOO = enum.auto()
    TATTOO_FLIP = enum.auto()
    TATTOO_COLOR = enum.auto()
    EYELINER = enum.auto()
    EYELINER_COLOR = enum.auto()
    EYESHADOW = enum.auto()
    EYESHADOW_COLOR = enum.auto()
    BLUSH = enum.auto()
    BLUSH_COLOR = enum.auto()
    LIPSTICK = enum.auto()
    LIPSTICK_COLOR = enum.auto()
    ARMOR_PATTERN = enum.auto()
    UNDER_ARMOR_PATTERN = enum.auto()
    ARMOR_COLOR_PRIMARY = enum.auto()
    ARMOR_COLOR_SECONDARY = enum.auto()
    ARMOR_COLOR_TERTIARY = enum.auto()
    EMOTE = enum.auto()
    BANNER_SHAPE = enum.auto()
    BANNER_SHAPE_COLOR = enum.auto()
    BANNER_PATTERN = enum.auto()
    BANNER_PATTERN_COLOR = enum.auto()
    BANNER_ICON = enum.auto()
    BANNER_ICON_COLOR = enum.auto()
